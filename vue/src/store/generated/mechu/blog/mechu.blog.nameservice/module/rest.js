...
export class Api extends HttpClient {
    constructor() {
         ...
         * @request GET:/mechu/blog/nameservice/whois
         */
        this.queryWhoisAll = (query, params = {}) => this.request({
            path: `/mechu/blog/nameservice/whois`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/mechu/blog/nameservice/whois/{index}
         */
        this.queryWhois = (index, params = {}) => this.request({
            path: `/mechu/blog/nameservice/whois/${index}`,
            method: "GET",
            format: "json",
            ...params,
        });
