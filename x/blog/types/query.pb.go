...
func init() {
	proto.RegisterType((*QueryPostsRequest)(nil), "mechu.blog.blog.QueryPostsRequest")
	proto.RegisterType((*QueryPostsResponse)(nil), "mechu.blog.blog.QueryPostsResponse")
}
...
var fileDescriptor_6e22cd6d352f3384 = []byte{
	...
	,
}
...
func (c *queryClient) Posts(ctx context.Context, in *QueryPostsRequest, opts ...grpc.CallOption) (*QueryPostsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mechu.blog.blog.Query/Posts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Posts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mechu.blog.blog.Query/Posts",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mechu.blog.blog.Query",
