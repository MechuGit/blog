...
type MsgCreatePost struct {
	...
	Body2   string `protobuf:"bytes,4,opt,name=body2,proto3" json:"body2,omitempty"`
...
func (m *MsgCreatePost) GetBody2() string {
	if m != nil {
		return m.Body2
	}
	return ""
...
func (m *MsgCreatePost) GetNum() uint64 {
	if m != nil {
		return m.Num
	}
	return 0
...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "mechu.blog.blog.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "mechu.blog.blog.MsgCreatePostResponse")
}
...
var fileDescriptor_90382f40c04acbba = []byte{
	...
	0xd7, 0x2f, 0xa9, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0xcf, 0x4d, 0x4d, 0xce, 0x28,
	0xd5, 0x03, 0x09, 0x82, 0x09, 0xa5, 0x6a, 0x2e, 0x5e, 0xdf, 0xe2, 0x74, 0xe7, 0xa2, 0xd4, 0xc4,
	0x92, 0xd4, 0x80, 0xfc, 0xe2, 0x12, 0x21, 0x09, 0x2e, 0xf6, 0x64, 0x10, 0x2f, 0xbf, 0x48, 0x82,
	...
	,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mechu.blog.blog.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mechu.blog.blog.Msg/CreatePost",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mechu.blog.blog.Msg",
...
func (m *MsgCreatePost) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Body2) > 0 {
		i -= len(m.Body2)
		copy(dAtA[i:], m.Body2)
		i = encodeVarintTx(dAtA, i, uint64(len(m.Body2)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Body) > 0 {
...
func (m *MsgCreatePost) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Body2", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Body2 = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 0 {
